...
$('checkNow').addEventListener('click', async () => {
  $('formMessage').textContent = 'Checking Ruralco now...';
  ...
  $('formMessage').textContent = data.result.diff.changed ? 'Change found. SMS sent if Twilio is configured.' : 'No Ruralco change found.';
  await loadStatus();
});
